...
public class PrepareInsertAbitanteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//mantengo i parametri della ricerca
		...
		System.out.println(request.getAttribute("nomeInput"));
		
		RequestDispatcher rd = request.getRequestDispatcher("inserisciAbitante.jsp");
